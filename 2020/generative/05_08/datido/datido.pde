...
PVector def(float x, float y, float z, float det, float amp) {
  float a1 = (float) SimplexNoise.noise(x*det, y*det, z*det+seed*0.02)*TAU*2;
  float a2 = (float) SimplexNoise.noise(x*det, y*det+seed*0.02, z*det)*TAU*2;
